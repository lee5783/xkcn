...
public abstract class XKGridViewLoadMoreListener implements OnScrollListener
{
	...
	public XKGridViewLoadMoreListener()
	{
	}

	public XKGridViewLoadMoreListener(int visibleThreshold)
	{
		this.visibleThreshold = visibleThreshold;
	}

	public XKGridViewLoadMoreListener(int visibleThreshold, int startPage)
	{
		this.visibleThreshold = visibleThreshold;
